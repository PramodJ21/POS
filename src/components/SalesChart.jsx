...
// Import your styles object
import styles from './SalesChart.module.css'; // Adjust with your styles path

const SalesChart = ({ aggregatedSalesData }) => {
  // Sort aggregatedSalesData by date in ascending order
  const sortedData = aggregatedSalesData.sort((a, b) => new Date(a.date) - new Date(b.date));
